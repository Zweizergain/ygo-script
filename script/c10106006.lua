...
function c10106006.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetReset(RESET_PHASE+PHASE_END)
	e1:SetTarget(c10106006.distg)
	Duel.RegisterEffect(e1,tp)
end
function c10106006.distg(e,c)
...
function c10106006.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c10106006.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c10106006.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c10106006.thfilter,tp,LOCATION_DECK,0,1,1,nil)
