...
function c10113083.desfilter(c)
	return c:IsFaceup() and c:IsCode(10113074,10113075,10173038)
end
...
function c10113083.cfilter(c)
	return c:IsFaceup() and not c:IsCode(10113074,10113075,10173038) and c:IsPreviousLocation(LOCATION_EXTRA) and c:IsAbleToRemove() and c:IsLocation(LOCATION_MZONE)
end
