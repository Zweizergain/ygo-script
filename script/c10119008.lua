...
function c10119008.sumfilter(c,tp)
	...
	return bit.band(c:GetSummonType(),SUMMON_TYPE_XYZ)==SUMMON_TYPE_XYZ and mg:GetCount()>0 and mg:IsExists(c10119008.effilter,1,nil,tp) 
end
...
function c10119008.cdsstg(e,c)
	local mg=c:GetMaterial()
	return bit.band(c:GetSummonType(),SUMMON_TYPE_XYZ)==SUMMON_TYPE_XYZ and mg:GetCount()>0 and mg:IsExists(c10119008.effilter,1,nil,e:GetHandlerPlayer())
end
