...
function c10123006.sumfilter(c,tp)
	...
	return bit.band(c:GetSummonType(),SUMMON_TYPE_SYNCHRO)==SUMMON_TYPE_SYNCHRO and mg:GetCount()>0 and mg:IsExists(c10123006.effilter,1,nil,tp) 
end
...
function c10123006.cdsstg(e,c)
	local mg=c:GetMaterial()
	return bit.band(c:GetSummonType(),SUMMON_TYPE_SYNCHRO)==SUMMON_TYPE_SYNCHRO and mg:GetCount()>0 and mg:IsExists(c10123006.effilter,1,nil,e:GetHandlerPlayer())
end
