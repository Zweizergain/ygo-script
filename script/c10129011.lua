...
function c10129011.atkval(e,c)
	return Duel.GetMatchingGroupCount(c10129011.atkfilter,c:GetControler(),LOCATION_MZONE,0,nil)*800
end
...
function c10129011.costchk(e,te_or_c,tp)
	...
	return Duel.CheckLPCost(tp,ct*500) and tp~=e:GetHandlerPlayer()
end
