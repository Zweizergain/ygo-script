...
function c10129014.tfcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:IsPreviousPosition(POS_FACEUP) and not c:IsLocation(LOCATION_DECK) and c:GetFlagEffect(10129014)>0
end
...
function c10129014.rmop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
	   ...
	   if Duel.Remove(g,POS_FACEUP,REASON_EFFECT+REASON_TEMPORARY)~=0 then
		  c:RegisterFlagEffect(10129014,RESET_EVENT+RESET_OVERLAY+RESET_TOFIELD,0,1)
