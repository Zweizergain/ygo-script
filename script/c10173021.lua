...
function c10173021.matfilter(c)
...
function c10173021.spfilter1(c,tp,g)
	return g:IsExists(c10173021.spfilter2,1,c,tp,c)
end
function c10173021.spfilter2(c,tp,mc)
...
function c10173021.sprcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c10173021.matfilter,tp,LOCATION_ONFIELD+LOCATION_HAND,0,nil)
	return g:IsExists(c10173021.spfilter1,1,nil,tp,g)
end
function c10173021.sprop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c10173021.matfilter,tp,LOCATION_ONFIELD+LOCATION_HAND,0,nil)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g1=g:FilterSelect(tp,c10173021.spfilter1,1,1,nil,tp,g)
	local mc=g1:GetFirst()
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g2=g:FilterSelect(tp,c10173021.spfilter2,1,1,mc,tp,mc)
	g1:Merge(g2)
	c:SetMaterial(g1)
