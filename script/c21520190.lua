...
function c21520190.initial_effect(c)
	...
	e2_2:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY+EFFECT_FLAG_CANNOT_DISABLE)
	e2_2:SetCode(EVENT_SPSUMMON_SUCCESS)
	e2_2:SetOperation(c21520190.ctop)
...
function c21520190.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local c=e:GetHandler()
	local tc=Duel.SelectTarget(tp,c21520190.filter,tp,LOCATION_ONFIELD,0,1,1,e:GetHandler())
