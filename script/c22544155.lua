...
function c22544155.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if not e:IsHasType(EFFECT_TYPE_ACTIVATE) and e:GetHandler():IsLocation(LOCATION_ONFIELD) then return end
	e:GetHandler():RegisterFlagEffect(22544155,RESET_TODECK,0,0)
end 
function c22544155.drawtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return  Duel.IsPlayerCanDraw(tp,2) and c:GetFlagEffect(22544155)>0 end
