...
function c511009168.initial_effect(c)
	...
	e0:SetTarget(c511009168.equtg)
	e0:SetOperation(c511009168.equop)
	c:RegisterEffect(e0)
	--Equip limit
...
function c511009168.effcon(e,c)
	return c:IsSetCard(0xc008)
end
function c511009168.equfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xc008)
end
function c511009168.equtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c511009168.eqfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c511009168.equfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
	Duel.SelectTarget(tp,c511009168.eqfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,e:GetHandler(),1,0,0)
end
function c511009168.equop(e,tp,eg,ep,ev,re,r,rp)
