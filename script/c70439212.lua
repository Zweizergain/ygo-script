...
function cm.spfilter(c,e,tp,tid)
	return c:IsSetCard(0xf10) and c:IsType(TYPE_MONSTER)  and c:IsCanBeEffectTarget(e) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.tgfilter(c)
	return c:IsSetCard(0xf10) and c:IsType(TYPE_MONSTER) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
